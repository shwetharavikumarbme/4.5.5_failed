...
const TrendingNav = ({ scrollRef }) => {
    ...
    const getCommentCountById = (forumId) => {
        return commentCounts[forumId] ?? commentsCount[forumId] ?? 0;
    };
    ...
    const renderItem = useCallback(({ item }) => {
        ...
        return (
            ...
            >
              <Ionicons name={activeVideo === item.forum_id ? null : "play"} size={40} color="white" />
            </TouchableOpacity> */}
                        </TouchableOpacity>
